...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/workers-ai
```

A live public deployment of this template is available at [https://workers-ai.templates.workers.dev](https://workers-ai.templates.workers.dev)
